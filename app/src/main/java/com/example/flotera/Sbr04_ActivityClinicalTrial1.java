...
public class Sbr04_ActivityClinicalTrial1 extends Activity implements SimpleGestureFilter.SimpleGestureListener {
    ...
    public void function(){
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(Sbr04_ActivityClinicalTrial1.this, MainActivity.class);
                startActivity(a);
                finish();
            }
        });
