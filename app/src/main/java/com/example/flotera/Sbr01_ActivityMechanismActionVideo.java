...
public class Sbr01_ActivityMechanismActionVideo extends Activity implements SimpleGestureFilter.SimpleGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sbr01_mechanism_action_video);
    ...
    public void function(){
        ...
        btn_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Sbr01_ActivityMechanismActionVideo.this, MainActivity.class);
                startActivity(i);
                finish();
            }
        });
