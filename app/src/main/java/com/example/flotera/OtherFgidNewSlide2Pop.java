...
public class OtherFgidNewSlide2Pop extends Activity{
...
//    LinearLayout zoomin,zoomout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.otherfgid_newslide2_pop);
...
//        });
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(OtherFgidNewSlide2Pop.this, MainActivity.class);
                startActivity(a);
                finish();
            }
        });
        popup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(OtherFgidNewSlide2Pop.this, OtherFgidNewSlide.class);
                startActivity(a);
                finish();
            }
        });
