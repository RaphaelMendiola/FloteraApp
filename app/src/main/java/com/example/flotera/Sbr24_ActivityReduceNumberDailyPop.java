...
public class Sbr24_ActivityReduceNumberDailyPop extends Activity{
...
RelativeLayout popup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sbr24_activity_reduce_number_daily_pop);
...
//        });
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(Sbr24_ActivityReduceNumberDailyPop.this, MainActivity.class);
                startActivity(a);
                finish();
            }
        });
        popup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(Sbr24_ActivityReduceNumberDailyPop.this, NewRegulatory.class);
                startActivity(a);
                finish();
            }
        });
