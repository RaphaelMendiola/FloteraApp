...
public class Sbr31_ActivityHowToUse3 extends Activity implements SimpleGestureFilter.SimpleGestureListener {
...
//    LinearLayout zoomin,zoomout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sbr31_activity_how_to_iuse_3);
...
//        });
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(Sbr31_ActivityHowToUse3.this, MainActivity.class);
                startActivity(a);
                finish();
            }
        });
    ...
    public void onSwipe(int direction) {
        switch (direction) {
            ...
            case SimpleGestureFilter.SWIPE_RIGHT:
                ...
                swish.start();
                Intent a = new Intent(Sbr31_ActivityHowToUse3.this, OtherFgidNewSlide.class);
                startActivity(a);
                finish();
            ...
            case SimpleGestureFilter.SWIPE_LEFT:
                ...
                swish.start();
                Intent b = new Intent(Sbr31_ActivityHowToUse3.this, Sbr30_ActivityDosageForTreat3.class);
                startActivity(b);
                finish();
