...
public class Sbr19_ActivityHowToUse extends Activity implements SimpleGestureFilter.SimpleGestureListener {
...
//    LinearLayout zoomin,zoomout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sbr19_activity_how_to_use);
...
//        });
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(Sbr19_ActivityHowToUse.this, MainActivity.class);
                startActivity(a);
                finish();
            }
        });
    ...
    public void onSwipe(int direction) {
        switch (direction) {
            ...
            case SimpleGestureFilter.SWIPE_RIGHT:
                swish.start();
                Intent a = new Intent(Sbr19_ActivityHowToUse.this, Sbr_ColicSlide12_New.class);
                startActivity(a);
                finish();
            ...
            case SimpleGestureFilter.SWIPE_LEFT:
                swish.start();
                Intent b = new Intent(Sbr19_ActivityHowToUse.this, Sbr18_ActivityDosageForTreatment.class);
                startActivity(b);
                finish();
